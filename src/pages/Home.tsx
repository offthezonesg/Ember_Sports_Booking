      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('pricing.title')}</h2>
            <p className="text-gray-600">{t('pricing.subtitle')}</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: t('pricing.standard'), price: 80, desc: 'A-D' },
              { name: t('pricing.vip'), price: 120, desc: 'E-F' },
              { name: t('pricing.training'), price: 60, desc: 'G-H' },
            ].map((item, index) => (
              <motion.div
                key={item.name}
